...
import 'package:food_preorder_app/APIinfos.dart';
    ...
    on<AuthenticateUser>((event, emit) async {
      ...
      if (event.userName.isEmpty) {
        ...
        try{
          ...
          final url = Uri.parse('http://ivalunch-001-site1.atempurl.com/api/User/Login?username=${event.userName}&password=${event.password}');
...
Future<int> Get_orders_completed(int id) async {
  try {
    final url = Uri.parse('http://ivalunch-001-site1.atempurl.com/api/User/GetEmployeeLunchCount/${id.toString()}');
    final headers = {
